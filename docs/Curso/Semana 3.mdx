...
### Actividad: Sistema de Puntos de Fidelización

**Objetivo:** Aplicar conceptos básicos de Java, como la declaración de variables, operadores aritméticos, operadores de comparación, operadores lógicos y conversiones de tipos de datos, para simular un sistema de puntos de fidelización para un comercio.

**Contexto:**

Eres el desarrollador de un sistema de puntos de fidelización para un comercio. Necesitas crear un programa que calcule los puntos que un cliente acumula por sus compras, y que determine si el cliente ha alcanzado un determinado nivel de fidelización.
